<footer class="footer">
                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6 col-lg-3">
                        <div class="footer_widget">
                            ...
                            <img width="150" src="<?php echo base_url('');?>style/img/tut-wuri-handayani-7759.png" class="rounded" alt="SD N 06 Kendalsari">
                        </div>
                    </div>
                    <div class="col-xl-3 col-md-6 col-lg-3">
                        <div class="footer_widget">
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> <a href="https://suryaciptainformatika.com/" target="_blank">SD N 06 Kendalsari</a> | Distributed by <a href="https://blogbugabagi.blogspot.com" target="_blank" rel="noopener noreferrer" style="color:azure">BlogBugaBagi</a></p>
                        </p>
                    </div>
                </div>
            </div>
